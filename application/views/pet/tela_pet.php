    ...
    <div class="col-md-8">
        ...
        <div class="panel panel-<?php echo $panel; ?>">
            ...
            <?php if ( !preg_match("/evento\b/", uri_string()) && (
                    (substr(uri_string(), 0, strpos(uri_string(), '/')) != 'pet' && ($metodo == 1 || $metodo == 3) ) || 
                    ($metodo != 1 && $metodo != 3) 
                    ) )  { ?>
            ...
            <div class="panel panel-footer text-center">
                    ...
                    <a href="<?php echo base_url() . 'pet/prontuario/' . $resumo['idApp_Paciente']; ?>" type="button" class="btn btn-sm btn-warning">
                    ...
                    <a href="<?php echo base_url() . 'pet/alterar/' . $resumo['idApp_Paciente']; ?>" type="button" class="btn btn-sm btn-info">
                        <span class="glyphicon glyphicon-edit"></span> Editar Dados</a>
                    <a href="<?php echo base_url() . 'pet/excluir/' . $resumo['idApp_Paciente']; ?>" type="button" class="btn btn-sm btn-danger">
