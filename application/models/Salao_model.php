...
class Salao_model extends CI_Model {
    ...
    public function set_salao($data) {
    ...
    public function get_salao($data) {
    ...
    public function update_salao($data, $id) {
    ...
    public function delete_salao($data) {
    ...
    public function lista_salao($data, $x) {
        ...
        $query = $this->db->query('SELECT * '
                ...
                . 'NomeSalao like "%' . $data . '%" OR '
                . 'SalaoDataNascimento = "' . $this->basico->mascara_data($data, 'mysql') . '" OR '
                . 'Telefone like "%' . $data . '%") '
                . 'ORDER BY NomeSalao ASC ');
        /*
          echo $this->db->last_query();
          echo "<pre>";
          print_r($query);
        ...
        if ($query->num_rows() === 0) {
            ...
            if ($x === FALSE) {
                ...
                foreach ($query->result() as $row) {
                    ...
                    $row->SalaoDataNascimento = $this->basico->mascara_data($row->SalaoDataNascimento, 'barras');
                }
