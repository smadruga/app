...
class Paciente_model extends CI_Model {
    ...
    public function set_paciente($data) {
    ...
    public function get_paciente($data) {
    ...
    public function update_paciente($data, $id) {
    ...
    public function delete_paciente($data) {
    ...
    public function lista_paciente($data, $x) {
